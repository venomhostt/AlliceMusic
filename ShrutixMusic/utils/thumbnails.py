...
# Add gradient generation without numpy
def create_gradient(size, start_color, end_color, direction='diagonal'):
    """Create a gradient background without numpy"""
