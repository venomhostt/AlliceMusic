...
CANVAS_W, CANVAS_H = 1400, 850  # Slightly larger canvas
BG_BLUR = 20
BG_BRIGHTNESS = 0.85  # Slightly darker for contrast

# Modern color palette
LIME_BORDER = (0, 255, 163, 255)  # More vibrant cyan-lime
RING_COLOR = (98, 193, 169, 255)
GLOW_COLOR = (0, 255, 163, 100)
TEXT_WHITE = (255, 255, 255, 255)
TEXT_SOFT = (220, 220, 220, 255)
TEXT_NEON = (0, 255, 163, 255)  # Neon accent for key text
TEXT_SHADOW = (0, 0, 0, 180)
GRADIENT_START = (0, 20, 40, 180)  # Dark blue
GRADIENT_END = (0, 0, 0, 120)  # Black

FONT_REGULAR_PATH = "ShrutixMusic/assets/font2.ttf"
FONT_BOLD_PATH = "ShrutixMusic/assets/font3.ttf"
FONT_MODERN_PATH = "ShrutixMusic/assets/font3.ttf"  # Use bold for modern look
