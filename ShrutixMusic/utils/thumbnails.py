    ...
    try:
        ...
        try:
            ...
            try:
                ...
                pass            wrapped = wrap_text_ellipsis(draw, text, font, max_width)
    ...
    try:
        ...
        if thumb_path and os.path.exists(thumb_path):
            try:
                ...
                print(f"[Final Cleanup Error] {cleanup_error}")                break
...
async def get_thumb(videoid: str):
    """Generate thumbnail matching the reference image style"""
    url = f"https://www.youtube.com/watch?v={videoid}"
    thumb_path = None
